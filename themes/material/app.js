...
function nav(path) {
    ...
    <a href="https://server2.boimovies.workers.dev/0:/Movies%203/Android%20Apps/Boi_Movies_1.3.5.apk" target="MoviezCinemas Share" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'GoIndex Drive on Github'}">
